        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    <img style="background-color:#ffdab3" src="<?php echo isset($data->url)?config_item('base_domain').$data->url:'' ?>" alt="<?php echo isset($data->title)?$data->title:'' ?>" class="img-responsive img-thumbnail">
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                ...
                <div class="form-group">
                    <button type="button" name="button" class="btn btn-sm btn-warning btn_action" data-idle="Update" data-form="#form_data" data-process="Updating..." data-form="#form_data" data-redirect="<?php echo base_url('photo/index').get_query_string() ?>">Update</button>
