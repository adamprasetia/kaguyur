<div class="box box-default">
    <div class="box-header with-border">
        <a href="<?php echo base_url('product/add') ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Tambah Produk</a>
        ...
        <div class="table-responsive no-margin">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $no; ?></td>
                        <td><a href="<?php echo base_url('product/edit/'.$value->id); ?>"><?php echo $value->name; ?></a></td>
