<div class="box box-default">
    <div class="box-header with-border">
        <a data-module="<?php echo 'member/add' ?>" href="<?php echo base_url('member/add') ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Tambah Anggota</a>
    ...
    <div class="box-header with-border">
        ...
        <a href="<?php echo base_url('member/export').get_query_string() ?>" class="btn btn-default btn-sm"><i class="fa fa-download"></i> Export to Excel</a>
        <div class="pull-right">
