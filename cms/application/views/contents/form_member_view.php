  ...
  <div class="col-md-6">
    <div class="box box-default">
      ...
      <div class="box-body with-border">        
        ...
        <div class="form-group">
          <label>Alamat *</label>
          <textarea name="address" id="address" cols="30" rows="5" class="form-control"><?php echo isset($data->address)?$data->address:''; ?></textarea>
        </div>
        <div class="form-group">
    ...
    <div class="box box-default">
        <div class="box-body">
          ...
          <div class="form-group">
            <div class="media">
              <div class="media-left">
                <img id="photo_img" src="<?php echo isset($data->photo)?gen_thumb($data->photo,'300x300'):''; ?>" class="media-object" style="width: 100px;height: auto;border-radius: 10px;box-shadow: 0 1px 3px rgba(0,0,0,.15);">
          ...
          <div class="form-group">
            <div class="media">
              <div class="media-left">
                <img id="logo_img" src="<?php echo isset($data->logo)?gen_thumb($data->logo,'300x300'):''; ?>" class="media-object" style="width: 100px;height: auto;border-radius: 10px;box-shadow: 0 1px 3px rgba(0,0,0,.15);">
          ...
          <div class="form-group">
            ...
            <textarea name="strain" id="strain" cols="30" rows="2" class="form-control"><?php echo isset($data->strain)?$data->strain:''; ?></textarea>
          </div>
        </div>
        </div>
        <div class="box box-default">
      ...
      <?php if(!empty($data->barcode)): ?>
        ...
        <div class="box-footer">        
          ...
          <div class="pull-right">
            <a href="<?php echo config_item('base_domain').'login/reset_password/'.$data->id.'/'.md5($data->id.'hs^35shKjsdh()'); ?>">Reset Password</a>
          </div>
        </div>
