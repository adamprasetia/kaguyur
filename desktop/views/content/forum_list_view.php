<div class="section py-20 bg-cover bg-no-repeat mt-10">
    ...
    <div class="container px-5 mx-auto">
        <h1 class="font-bold uppercase">PERTANYAAN SAYA</h1>
        <div class="grid grid-cols-6 gap-10">
            <div class="col-span-6 md:col-span-3">
                <div class="mt-5">
                <a href="<?php echo base_url('forum/add') ?>" class="btn btn__black">TAMBAH PERTANYAAN</a>
                </div>
                <div class="mt-5">
                    <ul>
                        ...
                        <li class="grid grid-cols-8 gap-4 mb-5">
                            <div class="col-span-5 md:col-span-6">
                                <a href="<?php echo base_url('forum/edit/'.$row->id) ?>">
