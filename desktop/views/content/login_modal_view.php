        ...
        <div class="p-5 text-sm">
          <form method="post" id="form_login" action="<?php echo base_url('login/do_login'); ?>">
            ...
            <div class="mb-3">
              ...
              <p><a href="javascript:void(0);" onclick="MicroModal.close('modal-login');MicroModal.show('modal-forgote');">Lupa password ? klik disini</a></p>
            </div>
            ...
            <div class="text-center">
              <p><a href="javascript:void(0);" onclick="MicroModal.close('modal-login');MicroModal.show('modal-register');">Belum punya akun ? silakan daftar disini </a></p>
            </div>
          </form>
        </div>
      </main>
