    ...
    <div class="text-sm">
          <form method="post" id="form_data" action="<?php echo base_url('profile/update') ?>">
            ...
            <div class="mb-3">
              ...
              <img src="<?php echo isset($profile->photo)?config_item('base_domain').$profile->photo:''; ?>" class="media-object" style="width: 200px;height: auto;border-radius: 10px;box-shadow: 0 1px 3px rgba(0,0,0,.15);">
              <?php endif ?>
            ...
            <div class="mb-3">
              ...
              <img src="<?php echo isset($profile->logo)?config_item('base_domain').$profile->logo:''; ?>" class="media-object" style="width: 200px;height: auto;border-radius: 10px;box-shadow: 0 1px 3px rgba(0,0,0,.15);">
              <?php endif ?>
